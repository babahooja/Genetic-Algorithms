...
GameManipulator.readSensors = function () {
  ...
  for (var k in GameManipulator.sensors) {
    ...
    if (end) {
      ...
      //We go backwards to Calculate the size of the obstacle,
      //from the end point of the obstacle we discovered.
  ...
  //If called from startNewGame() this is a callback to that
...
//
// Simply maps a real number to string actions
//
