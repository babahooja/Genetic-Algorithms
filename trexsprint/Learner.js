...
Learn.executeGeneration = function (){
  ...
  //mapSeries will execute 'executeGenome() for each of the genomes'
  //the third argument will execute when all the Genomes are done Executing
...
Learn.executeGenome = function (genome, next){
  ...
  Learn.gm.startNewGame(function (){
    ...
    Learn.gm.onSensorData = function (){
      ...
      // Apply to network
      //Activate is a function object of The network class of Synaptic Library
